...
268| [Missing Number](https://leetcode.com/problems/missing-number/) |   [Python](./Python)  | _O(n)_ |  _O(1)_ | Medium         | LintCode ||
...
080 | [Remove Duplicates from Sorted Array II](https://leetcode.com/problems/remove-duplicates-from-sorted-array-ii/)|    [Python](./Python) | _O(n)_       | _O(1)_         | Medium         || Two Pointers
...
422| [Valid Word Square](https://leetcode.com/problems/valid-word-square/) |   [Python](./Python)  | _O(m * n)_ |  _O(1)_ | Easy         |🔒||
...
792 | [Number of Matching Subsequences](https://leetcode.com/problems/number-of-matching-subsequences/) |   [Python](./Python) | _O(n + w)_ | _O(1)_ | Medium ||
...
521| [Longest Uncommon Subsequence I](https://leetcode.com/problems/longest-uncommon-subsequence-i/) |    [Python](./Python) | _O(min(a, b))_ | _O(1)_ | Easy         | |
...
820| [Short Encoding of Words](https://leetcode.com/problems/short-encoding-of-words/) |    [Python](./Python) | _O(n)_ | _O(t)_ | Medium         || Trie |
...
369| [Plus One Linked List](https://leetcode.com/problems/plus-one-linked-list/)|   [Python](./Python) | _O(n)_       | _O(1)_         | Medium         | 🔒 | Two Pointers |
...
739| [Daily Temperatures](https://leetcode.com/problems/daily-temperatures/) |   [Python](./Python) | _O(n)_  | _O(n)_         | Medium           ||
...
662 | [Maximum Width of Binary Tree](https://leetcode.com/problems/maximum-width-of-binary-tree/) |   [Python](./Python) | _O(n)_ | _O(h)_ | Medium | | DFS
...
219| [Contains Duplicate II](https://leetcode.com/problems/contains-duplicate-ii/)  |   [Python](./Python) | _O(n)_        | _O(n)_          | Easy           ||
...
594| [Longest Harmonious Subsequence](https://leetcode.com/problems/longest-harmonious-subsequence/) |   [Python](./Python) | _O(n)_ | _O(n)_ | Easy         | |
...
248| [Strobogrammatic Number III](https://leetcode.com/problems/strobogrammatic-number-iii/) |    [Python](./Python)  | _O(5^(n/2))_ | _O(n)_ | Hard         |🔒||
...
573 | [Squirrel Simulation](https://leetcode.com/problems/squirrel-simulation/) |   [Python](./Python) | _O(n)_ | _O(1)_ | Medium |🔒||
...
906 | [Super Palindromes](https://leetcode.com/problems/super-palindromes/) |   [Python](./Python) | _O(n^0.25 * logn)_ | _O(logn)_ | Hard |||
...
761| [Special Binary String](https://leetcode.com/problems/special-binary-string/) |   [Python](./Python) | _O(n^2)_          | _O(n)_          | Hard           ||
...
410| [Split Array Largest Sum](https://leetcode.com/problems/split-array-largest-sum/)|   [Python](./Python)   | _O(nlogs)_          | _O(1)_          | Hard         | |
436 | [Find Right Interval](https://leetcode.com/problems/find-right-interval/) |   [Python](./Python) | _O(nlogn)_ | _O(n)_ | Medium | |
475 | [Python](./Python) | _O((m + n) * logn)_ | _O(1)_ | Easy | |
540|[Single Element in a Sorted Array](https://leetcode.com/problems/dsingle-element-in-a-sorted-array/)|   [Python](./Python)| _O(logn)_ | _O(1)_ | Medium | |
658 | [Find K Closest Elements](https://leetcode.com/problems/find-k-closest-elements/) |   [Python](./Python) | _O(logn + k)_ | _O(1)_ | Medium | |
668 | [Kth Smallest Number in Multiplication Table](https://leetcode.com/problems/kth-smallest-number-in-multiplication-table/) |   [Python](./Python) | _O(m * log(m * n))_ | _O(1)_ | Hard | |
719 | [Find K-th Smallest Pair Distance](https://leetcode.com/problems/find-k-th-smallest-pair-distance/) |   [Python](./Python) | _O(nlogn + nlogw)_ | _O(1)_ | Hard | |
744 | [Find Smallest Letter Greater Than Target](https://leetcode.com/problems/find-smallest-letter-greater-than-target/) |   [Python](./Python) | _O(logn)_ | _O(1)_ | Easy | |
774 | [Minimize Max Distance to Gas Station](https://leetcode.com/problems/minimize-max-distance-to-gas-station/) |   [Python](./Python) | _O(nlogr)_ | _O(1)_ | Hard | |
786 | [K-th Smallest Prime Fraction](https://leetcode.com/problems/k-th-smallest-prime-fraction/) |   [Python](./Python) | _O(nlogr)_ | _O(1)_ | Hard | |
793 | [Preimage Size of Factorial Zeroes Function](https://leetcode.com/problems/preimage-size-of-factorial-zeroes-function/) |   [Python](./Python) | _O((logn)^2)_ | _O(1)_ | Hard | |
852 | [Peak Index in a Mountain Array](https://leetcode.com/problems/peak-index-in-a-mountain-array/) |   [Python](./Python) | _O(logn)_ | _O(1)_ | Easy | |
864 | [Random Pick with Blacklist](https://leetcode.com/problems/random-pick-with-blacklist/) |   [Python](./Python) | ctor: _O(b)_ <br> pick: _O(1)_ | _O(b)_ | Hard | |
875 | [Koko Eating Bananas](https://leetcode.com/problems/koko-eating-bananas/) |   [Python](./Python) | _O(nlogr)_ | _O(1)_ | Medium | |
878 | [Nth Magical Number](https://leetcode.com/problems/nth-magical-number/) |   [Python](./Python) | _O(logn)_ | _O(1)_ | Hard | |
894| [All Possible Full Binary Trees](https://leetcode.com/problems/all-possible-full-binary-trees/) |   [Python](./Python) | _O(n * 4^n / n^(3/2))_ | _O(n * 4^n / n^(3/2))_ | Medium    ||
911| [Online Election](https://leetcode.com/problems/online-election/) |   [Python](./Python) | ctor: _O(n)_<br> query : _O(logn)_ | _O(n)_ | Medium    ||

## Binary Search Tree
|  #  | Title           |  Solution       |  Time           | Space           | Difficulty    | Tag          | Note|
|-----|---------------- | --------------- | --------------- | --------------- | ------------- |--------------|-----|
220| [Contains Duplicate III](https://leetcode.com/problems/contains-duplicate-iii/)  |   [Python](./Python) | _O(nlogk)_        | _O(k)_          | Medium           ||
230 | [Kth Smallest Element in a BST](https://leetcode.com/problems/kth-smallest-element-in-a-bst/) |   [Python](./Python) | _O(max(h, k))_ | _O(min(h, k))_ | Medium ||
235 | [Lowest Common Ancestor of a Binary Search Tree](https://leetcode.com/problems/lowest-common-ancestor-of-a-binary-search-tree/) |   [Python](./Python) | _O(h)_ | _O(1)_ | Easy | EPI |
270| [Closest Binary Search Tree Value](https://leetcode.com/problems/closest-binary-search-tree-value/)|   [Python](./Python)   | _O(h)_          | _O(1)_          | Easy         | 🔒 |
285| [Inorder Successor in BST](https://leetcode.com/problems/inorder-successor-in-bst/)|   [Python](./Python)   | _O(h)_          | _O(1)_          | Medium         | 🔒 |
352 | [Data Stream as Disjoint Intervals](https://leetcode.com/problems/data-stream-as-disjoint-intervals/) |   [Python](./Python) | _O(logn)_ | _O(n)_ | Hard | |
449|[Serialize and Deserialize BST](https://leetcode.com/problems/serialize-and-deserialize-bst/)|   [Python](./Python)| _O(n)_ | _O(h)_ | Medium | | |
450|[Delete Node in a BST](https://leetcode.com/problems/delete-node-in-a-bst/)|   [Python](./Python)| _O(h)_ | _O(h)_ | Medium | | |
530|[Minimum Absolute Difference in BST](https://leetcode.com/problems/minimum-absolute-difference-in-bst/)|   [Python](./Python)| _O(n)_ | _O(h)_ | Easy | | |
776|[Split BST](https://leetcode.com/problems/split-bst/)|   [Python](./Python)| _O(n)_ | _O(h)_ | Medium | 🔒 | |
783|[Minimum Distance Between BST Nodes](https://leetcode.com/problems/minimum-distance-between-bst-nodes/)|   [Python](./Python)| _O(n)_ | _O(h)_ | Easy | | |

## Breadth-First Search
|  #  | Title           |  Solution       |  Time           | Space           | Difficulty    | Tag          | Note|
|-----|---------------- | --------------- | --------------- | --------------- | ------------- |--------------|-----|
102| [Binary Tree Level Order Traversal](https://leetcode.com/problems/binary-tree-level-order-traversal/)|   [Python](./Python)| _O(n)_| _O(n)_| Easy  ||
107| [Binary Tree Level Order Traversal II](https://leetcode.com/problems/binary-tree-level-order-traversal-ii/)| [Python](./Python) | _O(n)_| _O(n)_| Easy  ||
103| [Binary Tree Zigzag Level Order Traversal](https://leetcode.com/problems/binary-tree-zigzag-level-order-traversal/)| [Python](./Python) | _O(n)_| _O(n)_| Medium  ||  
117| [Populating Next Right Pointers in Each Node II](https://leetcode.com/problems/populating-next-right-pointers-in-each-node-ii/)|[Python](./Python)| _O(n)_ | _O(1)_ | Hard ||
127| [Word Ladder](https://leetcode.com/problems/word-ladder/)|[Python](./Python) | _O(n * d)_      | _O(d)_          | Medium         ||
130| [Surrounded Regions](https://leetcode.com/problems/surrounded-regions/)|  [Python](./Python)| _O(m * n)_ | _O(m + n)_ | Medium         ||
133| [Clone Graph](https://leetcode.com/problems/clone-graph/)| [Python](./Python)   | _O(n)_          | _O(n)_          | Medium         ||
207| [Course Schedule](https://leetcode.com/problems/course-schedule/)| [Python](./Python)   | _O(\|V\| + \|E\|)_          | _O(\|E\|)_          | Medium         || Topological Sort |
210| [Course Schedule II](https://leetcode.com/problems/course-schedule-ii/)| [Python](./Python)   | _O(\|V\| + \|E\|)_          | _O(\|E\|)_          | Medium         || Topological Sort |
261| [Graph Valid Tree](https://leetcode.com/problems/graph-valid-tree/)|   [Python](./Python)   | _O(\|V\| + \|E\|)_          | _O(\|V\| + \|E\|)_          | Medium         | 🔒 |
269| [Alien Dictionary](https://leetcode.com/problems/alien-dictionary/) |    [Python](./Python)  | _O(n)_ | _O(1)_ | Hard         |🔒| Topological Sort, BFS, DFS |
286| [Walls and Gates](https://leetcode.com/problems/walls-and-gates/)|   [Python](./Python)   | _O(m * n)_          | _O(g)_          | Medium         | 🔒 |
310| [Minimum Height Trees](https://leetcode.com/problems/minimum-height-trees/)|   [Python](./Python)   | _O(n)_          | _O(n)_          | Medium         ||
317| [Shortest Distance from All Buildings](https://leetcode.com/problems/shortest-distance-from-all-buildings/)|   [Python](./Python)   | _O(k * m * n)_          | _O(m * n)_          | Hard         | 🔒 |
433| [Minimum Genetic Mutation](https://leetcode.com/problems/minimum-genetic-mutation/)|   [Python](./Python)   | _O(n * b)_          | _O(b)_          | Medium         ||
444| [Sequence Reconstruction](https://leetcode.com/problems/sequence-reconstruction/)|   [Python](./Python)   | _O(n * s)_          | _O(n)_          | Medium         |🔒| Topological Sort |
542| [01 Matrix](https://leetcode.com/problems/01-matrix/)|   [Python](./Python)   | _O(m * n)_          | _O(m * n)_          | Medium         || DP
666| [Path Sum IV](https://leetcode.com/problems/path-sum-iv/)|   [Python](./Python)   | _O(n)_          | _O(w)_          | Medium         |🔒| Topological Sort |
675|[Cut Off Trees for Golf Event](https://leetcode.com/problems/cut-off-trees-for-golf-event/)|   [Python](./Python)| _O(t * m * n)_ | _O(m * n)_ | Hard | | `A* Search Algorithm` |
742|[Closest Leaf in a Binary Tree](https://leetcode.com/problems/closest-leaf-in-a-binary-tree/)|   [Python](./Python)| _O(n)_ | _O(n)_ | Medium | | |
743|[Network Delay Time](https://leetcode.com/problems/network-delay-time/)|   [Python](./Python)| _O(\|E\| * log\|V\|)_ | _O(\|E\|)_ | Medium | | `Dijkstra's algorithm` |
752|[Open the Lock](https://leetcode.com/problems/open-the-lock/)|   [Python](./Python)| _O(k * n^k + d)_ | _O(k * n^k + d)_ | Medium | | |
773|[Sliding Puzzle](https://leetcode.com/problems/sliding-puzzle/)|   [Python](./Python)| _O((m * n) * (m * n)!)_ | _O((m * n) * (m * n)!)_ | Hard | | `A* Search Algorithm` |
787|[Cheapest Flights Within K Stops](https://leetcode.com/problems/cheapest-flights-within-k-stops/)|   [Python](./Python)| _O(\|E\| * log\|V\|)_ | _O(\|E\|)_ | Medium | | `Dijkstra's algorithm` |
815|[Bus Routes](https://leetcode.com/problems/bus-routes/)|   [Python](./Python)| _O(\|E\| + \|V\|)_ | _O(\|E\| + \|V\|)_ | Hard | | |
854|[K-Similar Strings](https://leetcode.com/problems/k-similar-strings/)|   [Python](./Python)| _O(n * n!/(c_a!*...*c_z!))_ | _O(n * n!/(c_a!*...*c_z!))_ | Hard | | |
865|[Shortest Path to Get All Keys](https://leetcode.com/problems/shortest-path-to-get-all-keys/)|   [Python](./Python)| _O(k * r * c + k^3*2^k)_ | _O(k*2^k)_ | Hard | | `Dijkstra's algorithm` |
882|[Reachable Nodes In Subdivided Graph](https://leetcode.com/problems/reachable-nodes-in-subdivided-graph/)|   [Python](./Python)| _O(\|E\| * log\|V\|)_ | _O(\|E\|)_ | Hard | | `Dijkstra's algorithm` |
886|[Possible Bipartition](https://leetcode.com/problems/possible-bipartition/)|   [Python](./Python)| _O(\|V\| + \|E\|)_ | _O(\|V\| + \|E\|)_ | Medium | | |

## Depth-First Search
|  #  | Title           |  Solution       |  Time           | Space           | Difficulty    | Tag          | Note|
|-----|---------------- | --------------- | --------------- | --------------- | ------------- |--------------|-----|
112| [Path Sum](https://leetcode.com/problems/path-sum/)      | [Python](./Python)   | _O(n)_          | _O(h)_          | Easy           ||
113| [Path Sum II](https://leetcode.com/problems/path-sum-ii/)   | [Python](./Python) | _O(n)_         | _O(h)_          | Medium         ||
199| [Binary Tree Right Side View](https://leetcode.com/problems/binary-tree-right-side-view/) | [Python](./Python) | _O(n)_     | _O(h)_ | Medium  ||
200| [Number of Islands](https://leetcode.com/problems/number-of-islands/) | [Python](./Python) | _O(m * n)_ | _O(m * n)_| Medium         ||
236 | [Lowest Common Ancestor of a Binary Tree](https://leetcode.com/problems/lowest-common-ancestor-of-a-binary-tree/) |   [Python](./Python) | _O(n)_ | _O(h)_ | Medium | EPI |
247| [Strobogrammatic Number II](https://leetcode.com/problems/strobogrammatic-number-ii/) |    [Python](./Python)  | _O(n^2 * 5^(n/2))_ | _O(n)_ | Medium         |🔒||
250| [Count Univalue Subtrees](https://leetcode.com/problems/count-univalue-subtrees) |    [Python](./Python)  | _O(n)_ | _O(h)_ | Medium         |🔒||
257| [Binary Tree Paths](https://leetcode.com/problems/binary-tree-paths/) |    [Python](./Python)  | _O(n * h)_ | _O(h)_ | Easy         |||
282| [Expression Add Operators](https://leetcode.com/problems/expression-add-operators/) |    [Python](./Python)  | _O(4^n)_ | _O(n)_ | Hard         |||
301| [Remove Invalid Parentheses](https://leetcode.com/problems/remove-invalid-parentheses/) |    [Python](./Python)  | _O(C(n, c))_ | _O(c)_ | Hard         |||
329| [Longest Increasing Path in a Matrix](https://leetcode.com/problems/longest-increasing-path-in-a-matrix/) |    [Python](./Python)  | _O(m * n)_ | _O(m * n)_ | Hard         |||
332| [Reconstruct Itinerary](https://leetcode.com/problems/reconstruct-itinerary/) |    [Python](./Python)  | _O(t! / (n1! * n2! * ... nk!))_ | _O(t)_ | Medium         |||
339| [Nested List Weight Sum](https://leetcode.com/problems/nested-list-weight-sum/) |    [Python](./Python)  | _O(n)_ | _O(h)_ | Easy         |🔒||
364| [Nested List Weight Sum II](https://leetcode.com/problems/nested-list-weight-sum-ii/) |    [Python](./Python)  | _O(n)_ | _O(h)_ | Medium         |🔒||
366| [Find Leaves of Binary Tree](https://leetcode.com/problems/find-leaves-of-binary-tree/) |    [Python](./Python)  | _O(n)_ | _O(h)_ | Medium         |🔒||
399| [Evaluate Division](https://leetcode.com/problems/evaluate-division/) |    [Python](./Python)  | _O(q * \|V\|!)_ | _O(e)_ | Medium         |||
417 | [Pacific Atlantic Water Flow](https://leetcode.com/problems/pacific-atlantic-water-flow/) |   [Python](./Python) | _O(m * n)_ | _O(m * n)_ | Medium ||
440| [K-th Smallest in Lexicographical Order](https://leetcode.com/problems/k-th-smallest-in-lexicographical-order/) |   [Python](./Python) | _O(logn)_          | _O(logn)_          | Hard           ||
464| [Can I Win](https://leetcode.com/problems/can-i-win/) |   [Python](./Python) | _O(n!)_          | _O(n)_          | Medium           ||
515| [Find Largest Value in Each Tree Row](https://leetcode.com/problems/find-largest-value-in-each-tree-row/) |   [Python](./Python) | _O(n)_          | _O(h)_          | Medium           |||
547| [Friend Circles](https://leetcode.com/problems/friend-circles/) |   [Python](./Python) | _O(n^2)_          | _O(n)_          | Medium           || Union Find |
582| [Kill Process](https://leetcode.com/problems/kill-process/) |   [Python](./Python) | _O(n)_          | _O(n)_          | Medium           |🔒| DFS, BFS |
638| [Shopping Offers](https://leetcode.com/problems/shopping-offers/) |   [Python](./Python) | _O(n * 2^n)_          | _O(n)_          | Medium           ||
690| [Employee Importance](https://leetcode.com/problems/employee-importance/) |   [Python](./Python) | _O(n)_          | _O(h)_          | Easy           || DFS, BFS
694| [Number of Distinct Islands](https://leetcode.com/problems/number-of-distinct-islands/) |   [Python](./Python) | _O(m * n)_          | _O(m * n)_          | Medium           |🔒||
695| [Max Area of Island](https://leetcode.com/problems/max-area-of-island/) |   [Python](./Python) | _O(m * n)_          | _O(m * n)_          | Easy           ||
711| [Number of Distinct Islands II](https://leetcode.com/problems/number-of-distinct-islands-ii/) |   [Python](./Python) | _O((m * n) * log(m * n))_          | _O(m * n)_          | Hard           |🔒| Hash |
733| [Max Area of Island](https://leetcode.com/problems/flood-fill/) |   [Python](./Python) | _O(m * n)_          | _O(m * n)_          | Easy           ||
749| [Contain Virus](https://leetcode.com/problems/contain-virus/) |   [Python](./Python) | _O((m * n)^(4/3))_          | _O(m * n)_          | Hard           || Simulation|
753| [Cracking the Safe](https://leetcode.com/problems/cracking-the-safe/) |   [Python](./Python) | _O(k^n)_          | _O(k^n)_          | Hard           || `de Bruijn sequences`, `Lyndon word` |
756| [Pyramid Transition Matrix](https://leetcode.com/problems/pyramid-transition-matrix/) |   [Python](./Python) | _O(a^b)_          | _O(a^b)_          | Medium           |||
785| [Is Graph Bipartite?](https://leetcode.com/problems/is-graph-bipartite/) |   [Python](./Python) | _O(\|V\| + \|E\|)_          | _O(\|V\|)_          | Medium           |||
797| [All Paths From Source to Target](https://leetcode.com/problems/all-paths-from-source-to-target/) |   [Python](./Python) | _O(p + r * n)_          | _O(n)_          | Medium           |||
802| [Find Eventual Safe States](https://leetcode.com/problems/find-eventual-safe-states/) |   [Python](./Python) | _O(\|V\| + \|E\|)_          | _O(\|V\|)_ | Medium           |||
827| [Making A Large Island](https://leetcode.com/problems/making-a-large-island/) |   [Python](./Python) | _O(n^2)_          | _O(n^2)_          | Hard           |||
834| [Sum of Distances in Tree](https://leetcode.com/problems/sum-of-distances-in-tree/) |   [Python](./Python) | _O(n)_          | _O(n)_          | Hard           |||
841| [Keys and Rooms](https://leetcode.com/problems/keys-and-rooms/) |   [Python](./Python) | _O(n!)_          | _O(n)_          | Medium           |||
851| [Loud and Rich](https://leetcode.com/problems/loud-and-rich/) |   [Python](./Python) | _O(q + r)_          | _O(q + r)_          | Medium           |||
913| [Cat and Mouse](https://leetcode.com/problems/cat-and-mouse/) |   [Python](./Python) | _O(n^3)_          | _O(n^2)_          | Hard           |||

## Backtracking
|  #  | Title           |  Solution       |  Time           | Space           | Difficulty    | Tag          | Note|
|-----|---------------- | --------------- | --------------- | --------------- | ------------- |--------------|-----|
017| [Letter Combinations of a Phone Number](https://leetcode.com/problems/letter-combinations-of-a-phone-number/)| [Python](./Python) | _O(n * 4^n)_ | _O(n)_ | Medium ||
022| [Generate Parentheses](https://leetcode.com/problems/generate-parentheses/)| [Python](./Python)| _O(4^n / n^(3/2))_ | _O(n)_   | Medium         ||
037| [Sudoku Solver](https://leetcode.com/problems/sudoku-solver/) | [Python](./Python) | _O((9!)^9)_  | _O(1)_          | Hard           ||
039| [Combination Sum](https://leetcode.com/problems/combination-sum/)| [Python](./Python) | _O(k * n^k)_    | _O(k)_          | Medium         ||
040| [Combination Sum II](https://leetcode.com/problems/combination-sum-ii/)| [Python](./Python)| _O(k * C(n, k))_| _O(k)_         | Medium         ||
046| [Python](./Python) | _O(n * n!)_         | _O(n)_          | Medium         ||
047| [Permutations II](https://leetcode.com/problems/permutations-ii/)| [Python](./Python) | _O(n * n!)_   | _O(n)_          | Medium           ||
051| [N-Queens](https://leetcode.com/problems/n-queens/)      | [Python](./Python)   | _O(n!)_         | _O(n)_          | Hard           ||
052| [N-Queens-II](https://leetcode.com/problems/n-queens-ii/)   | [Python](./Python) | _O(n!)_        | _O(n)_          | Hard           ||
077| [Python](./Python) | _O(O(k * C(n, k)))_ | _O(k)_           | Medium         ||
079| [Word Search](https://leetcode.com/problems/word-search/) | [Python](./Python) | _O(m * n * l)_ | _O(l)_ | Medium         ||
093| [Restore IP Addresses](https://leetcode.com/problems/restore-ip-addresses/) | [Python](./Python) | _O(1)_ | _O(1)_ | Medium         ||
078| [Python](./Python)    | _O(n * 2^n)_    | _O(1)_          | Medium         ||
090| [Subsets II](https://leetcode.com/problems/subsets-ii/)    |   [Python](./Python) | _O(n * 2^n)_    | _O(1)_          | Medium         ||
126| [Word Ladder II](https://leetcode.com/problems/word-ladder-ii/)   |[Python](./Python) | _O(n * d)_ | _O(d)_         | Hard         ||
131| [Palindrome Partitioning](https://leetcode.com/problems/palindrome-partitioning/) | [Python](./Python) | _O(n^2)_ ~ _O(2^n)_ | _O(n^2)_ | Medium ||
140| [Word Break II](https://leetcode.com/problems/word-break-ii/)  |   [Python](./Python) |  _O(n * l^2 + n * r)_      | _O(n^2)_       | Hard           ||
212| [Word Search II](https://leetcode.com/problems/word-search-ii/) |   [Python](./Python) | _O(m * n * l)_ | _O(l)_  | Hard         | LintCode | Trie, DFS
216| [Combination Sum III](https://leetcode.com/problems/combination-sum-iii/)|   [Python](./Python) | _O(k * C(n, k))_    | _O(k)_          | Medium         ||
254| [Factor Combinations](https://leetcode.com/problems/factor-combinations/) |    [Python](./Python)  | _O(nlogn)_ | _O(logn)_ | Medium         |🔒||
267| [Palindrome Permutation II](https://leetcode.com/problems/palindrome-permutation-ii/) |   [Python](./Python)  | _O(n * n!)_ |  _O(n)_ | Medium         |🔒||
291| [Word Pattern II](https://leetcode.com/problems/word-pattern-ii/) |    [Python](./Python)  | _O(n * C(n - 1, c - 1))_ | _O(n + c)_ | Hard         |🔒||
294| [Flip Game II](https://leetcode.com/problems/flip-game-ii/) |   [Python](./Python)  | _O(n + c^2)_ | _O(c)_ | Medium         |🔒| DP, Hash |
320| [Generalized Abbreviation](https://leetcode.com/problems/generalized-abbreviation/) |   [Python](./Python)  | _O(n * 2^n)_ | _O(n)_ | Medium         |🔒||
425| [Word Squares](https://leetcode.com/problems/word-squares/) |   [Python](./Python)  | _O(n^2 * n!)_ | _O(n^2)_ | Hard         |🔒||
526| [Beautiful Arrangement](https://leetcode.com/problems/beautiful-arrangement/) |   [Python](./Python) | _O(n!)_ | _O(n)_  | Medium       ||
676| [Implement Magic Dictionary](https://leetcode.com/problems/implement-magic-dictionary/) |   [Python](./Python) | _O(n)_ | _O(d)_  | Medium       || Trie, DFS
679| [24 Game](https://leetcode.com/problems/24-game/) |   [Python](./Python) | _O(1)_ | _O(1)_  | Hard       || DFS
698| [Partition to K Equal Sum Subsets](https://leetcode.com/problems/partition-to-k-equal-sum-subsets/) |   [Python](./Python) | _O(n * 2^n)_ | _O(2^n)_ | Medium || DFS, DP, Memoization
718 | [Maximum Length of Repeated Subarray](https://leetcode.com/problems/maximum-length-of-repeated-subarray/) |   [Python](./Python) | _O(m * n)_ | _O(min(m, n))_ | Medium || DP, Hash, Binary Search
784| [Letter Case Permutation](https://leetcode.com/problems/letter-case-permutation/)    |   [Python](./Python) | _O(n * 2^n)_    | _O(1)_          | Easy         ||

## Dynamic Programming
|  #  | Title           |  Solution       |  Time           | Space           | Difficulty    | Tag          | Note|
|-----|---------------- | --------------- | --------------- | --------------- | ------------- |--------------|-----|
010| [Regular Expression Matching](https://leetcode.com/problems/regular-expression-matching/) | [Python](./Python) | _O(m * n)_ | _O(n)_ | Hard ||
053| [Maximum Subarray](https://leetcode.com/problems/maximum-subarray/)|[Python](./Python)| _O(n)_     | _O(1)_         | Medium         ||
062| [Unique Paths](https://leetcode.com/problems/unique-paths/)    | [Python](./Python)| _O(m * n)_      | _O(m + n)_   | Medium         ||
063| [Unique Paths II](https://leetcode.com/problems/unique-paths-ii/) | [Python](./Python) |  _O(m * n)_ | _O(m + n)_   | Medium         ||
064| [Minimum Path Sum](https://leetcode.com/problems/minimum-path-sum/)| [Python](./Python)| _O(m * n)_ | _O(m + n)_     | Medium         ||
070| [Climbing Stairs](https://leetcode.com/problems/climbing-stairs/)| [Python](./Python) | _O(n)_    | _O(1)_          | Easy           ||
072| [Edit Distance](https://leetcode.com/problems/edit-distance/)|[Python](./Python)| _O(m * n)_      | _O(m + n)_      | Hard           ||
087| [Scramble String](https://leetcode.com/problems/scramble-string/) | [Python](./Python) | _O(n^4)_ | _O(n^3)_        | Hard           ||
091| [Decode Ways](https://leetcode.com/problems/decode-ways/)   |  [Python](./Python)| _O(n)_          | _O(1)_          | Medium         ||
096| [Unique Binary Search Trees](https://leetcode.com/problems/unique-binary-search-trees/) | [Python](./Python) | _O(n)_      | _O(1)_         | Medium         || Math
097| [Interleaving String](https://leetcode.com/problems/interleaving-string/)|[Python](./Python)| _O(m * n)_ | _O(m + n)_ | Hard         ||
115| [Distinct Subsequences](https://leetcode.com/problems/distinct-subsequences/)|[Python](./Python)| _O(n^2)_ | _O(n)_ | Hard           ||
120| [Python](./Python)   | _O(m * n)_      | _O(n)_         | Medium         ||
123| [Best Time to Buy and Sell Stock III](https://leetcode.com/problems/best-time-to-buy-and-sell-stock-iii/) | [Python](./Python) | _O(n)_ | _O(1)_ | Hard ||
132| [Palindrome Partitioning II](https://leetcode.com/problems/palindrome-partitioning-ii/) | [Python](./Python) | _O(n^2)_ | _O(n^2)_ | Hard ||
139| [Word Break](https://leetcode.com/problems/word-break/)     |   [Python](./Python) |  _O(n * l^2)_         | _O(n)_       | Medium         ||
152| [Maximum Product Subarray](https://leetcode.com/problems/maximum-product-subarray/)|[Python](./Python)| _O(n)_ | _O(1)_ | Medium     ||
174| [Dungeon Game](https://leetcode.com/problems/dungeon-game/)  | [Python](./Python)| _O(m * n)_     | _O(m + n)_      | Hard           ||
188| [Best Time to Buy and Sell Stock IV](https://leetcode.com/problems/best-time-to-buy-and-sell-stock-iv/)| [Python](./Python) | _O(k * n)_ | _O(k)_ | Hard ||
198| [House Robber](https://leetcode.com/problems/house-robber/)| [Python](./Python) | _O(n)_          | _O(1)_          | Easy           ||
213| [House Robber II](https://leetcode.com/problems/house-robber-ii/)|   [Python](./Python) | _O(n)_          | _O(1)_          | Medium           ||
221| [Maximal Square](https://leetcode.com/problems/maximal-square/)|   [Python](./Python) | _O(n^2)_         | _O(n)_          | Medium           | EPI |
256| [Paint House](https://leetcode.com/problems/paint-house/) |   [Python](./Python) | _O(n)_| _O(1)_| Medium |🔒||
265| [Paint House II](https://leetcode.com/problems/paint-house-ii/) |   [Python](./Python) | _O(n * k)_| _O(k)_| Hard |🔒||
276| [Paint Fence](https://leetcode.com/problems/paint-fence/) |   [Python](./Python) | _O(n)_| _O(1)_| Easy |🔒||
279| [Perfect Squares](https://leetcode.com/problems/perfect-squares/)|   [Python](./Python) | _O(n * sqrt(n))_         | _O(n)_          | Medium           ||  Hash |
303| [Range Sum Query - Immutable](https://leetcode.com/problems/range-sum-query-immutable/)|   [Python](./Python) | ctor: _O(n)_, lookup: _O(1)_          | _O(n)_          | Easy           ||
304| [Range Sum Query 2D - Immutable](https://leetcode.com/problems/range-sum-query-2d-immutable/)|   [Python](./Python) | ctor: _O(m * n)_, lookup: _O(1)_          | _O(m * n)_          | Medium           ||
309| [Best Time to Buy and Sell Stock with Cooldown](https://leetcode.com/problems/best-time-to-buy-and-sell-stock-with-cooldown/) |   [Python](./Python) | _O(n)_ | _O(1)_ | Medium ||
312| [Burst Balloons](https://leetcode.com/problems/burst-balloons/) |   [Python](./Python) | _O(n^3)_ | _O(n^2)_ | Hard ||
322| [Coin Change](https://leetcode.com/problems/coin-change/) |   [Python](./Python) | _O(n * k)_ | _O(k)_ | Medium ||
351| [Android Unlock Patterns](https://leetcode.com/problems/android-unlock-patterns/) |   [Python](./Python) | _O(9^2 * 2^9)_ | _O(9 * 2^9)_ | Medium | 🔒 | Backtracking |
357| [Count Numbers with Unique Digits](https://leetcode.com/problems/count-numbers-with-unique-digits/) |   [Python](./Python) | _O(n)_ | _O(1)_ | Medium || Backtracking, Math |
361| [Bomb Enemy](https://leetcode.com/problems/bomb-enemy/) |   [Python](./Python) | _O(m * n)_ | _O(m * n)_ | Medium | 🔒 | |
368| [Largest Divisible Subset](https://leetcode.com/problems/largest-divisible-subset/) |   [Python](./Python) | _O(n^2)_ | _O(n)_ | Medium | | |
375| [Guess Number Higher or Lower II](https://leetcode.com/problems/guess-number-higher-or-lower-ii/)|   [Python](./Python)   | _O(n^2)_          | _O(n^2)_          | Medium         | |
377| [Combination Sum IV](https://leetcode.com/problems/combination-sum-iv/)|   [Python](./Python)   | _O(nlogn + n * t)_          | _O(t)_          | Medium         | |
403 | [Frog Jump](https://leetcode.com/problems/frog-jump/) |   [Python](./Python) | _O(n)_ | _O(n) ~ O(n^2)_ | Hard ||
416 | [Partition Equal Subset Sum](https://leetcode.com/problems/partition-equal-subset-sum/) |   [Python](./Python) | _O(n * s)_ | _O(s)_ | Medium ||
418 | [Sentence Screen Fitting](https://leetcode.com/problems/sentence-screen-fitting/) |   [Python](./Python) | _O(r + n * c)_ | _O(n)_ | Medium |🔒|
446 | [Arithmetic Slices II - Subsequence](https://leetcode.com/problems/arithmetic-slices-ii-subsequence/) |   [Python](./Python) | _O(n^2)_ | _O(n * d)_ | Hard ||
465 | [Optimal Account Balancing](https://leetcode.com/problems/optimal-account-balancing/) |   [Python](./Python) | _O(n * 2^n)_ | _O(n * 2^n)_ | Hard |🔒|
466 | [Count The Repetitions](https://leetcode.com/problems/count-the-repetitions/) |   [Python](./Python) | _O(s1 * min(s2, n1))_ | _O(s2)_ | Hard ||
467 | [Unique Substrings in Wraparound String](https://leetcode.com/problems/unique-substrings-in-wraparound-string/) |   [Python](./Python) | _O(n)_ | _O(1)_ | Medium ||
471 | [Encode String with Shortest Length](https://leetcode.com/problems/encode-string-with-shortest-length/) |   [Python](./Python) | _O(n^3)_ on average | _O(n^2)_ | Medium |🔒|
472 | [Concatenated Words](https://leetcode.com/problems/concatenated-words/) |   [Python](./Python) | _O(n * l^2)_ | _O(n * l)_ | Medium ||
474 | [Ones and Zeroes](https://leetcode.com/problems/ones-and-zeroes/) |   [Python](./Python) | _O(s * m * n)_ | _O(m * n)_ | Medium ||
486 | [Predict the Winner](https://leetcode.com/problems/predict-the-winner/) |   [Python](./Python) | _O(n^2)_ | _O(n)_ | Medium | | |
514 | [Freedom Trail](https://leetcode.com/problems/freedom-trail/) |   [Python](./Python) | _O(k)_ ~ _O(k * r^2)_ | _O(r)_ | Hard |||
516 | [Longest Palindromic Subsequence](https://leetcode.com/problems/longest-palindromic-subsequence/) |   [Python](./Python) | _O(n^2)_ | _O(n)_ | Medium |||
546 | [Remove Boxes](https://leetcode.com/problems/remove-boxes/) |   [Python](./Python) | _O(n^3)_ ~ _O(n^4)_ | _O(n^3)_ | Hard |||
552 | [Student Attendance Record II](https://leetcode.com/problems/student-attendance-record-ii/) |   [Python](./Python) | _O(n)_ | _O(1)_ | Hard |||
562 | [Longest Line of Consecutive One in Matrix](https://leetcode.com/problems/longest-line-of-consecutive-one-in-matrix/) |   [Python](./Python) | _O(m * n)_ | _O(n)_ | Medium |🔒||
568 | [Maximum Vacation Days](https://leetcode.com/problems/maximum-vacation-days/) |   [Python](./Python) | _O(n^2 * k)_ | _O(k)_ | Hard |🔒||
576 | [Out of Boundary Paths](https://leetcode.com/problems/out-of-boundary-paths/) |   [Python](./Python) | _O(N * m * n)_ | _O(m * n)_ | Medium |||
583 | [Delete Operation for Two Strings](https://leetcode.com/problems/delete-operation-for-two-strings/) |   [Python](./Python) | _O(m * n)_ | _O(n)_ | Medium |||
600 | [Non-negative Integers without Consecutive Ones](https://leetcode.com/problems/non-negative-integers-without-consecutive-ones/) |   [Python](./Python) | _O(1)_ | _O(1)_ | Hard |||
629 | [K Inverse Pairs Array](https://leetcode.com/problems/k-inverse-pairs-array/) |   [Python](./Python) | _O(n * k)_ | _O(k)_ | Hard |||
639 | [Decode Ways II](https://leetcode.com/problems/decode-ways-ii/) |   [Python](./Python) | _O(n)_ | _O(1)_ | Hard |||
650 | [2 Keys Keyboard](https://leetcode.com/problems/2-keys-keyboard/) |   [Python](./Python) | _O(sqrt(n))_ | _O(1)_ | Medium |||
656 | [Coin Path](https://leetcode.com/problems/coin-path/) |   [Python](./Python) | _O(n * B)_ | _O(n)_ | Hard |🔒|
664 | [Strange Printer](https://leetcode.com/problems/strange-printer/) |   [Python](./Python) | _O(n^3)_ | _O(n^2)_ | Hard ||
673 | [Number of Longest Increasing Subsequence](https://leetcode.com/problems/number-of-longest-increasing-subsequence/) |   [Python](./Python) | _O(n^2)_ | _O(n)_ | Medium ||
688 | [Knight Probability in Chessboard](https://leetcode.com/problems/knight-probability-in-chessboard/) |   [Python](./Python) | _O(k * n^2)_ | _O(n^2)_ | Medium ||
689 | [Maximum Sum of 3 Non-Overlapping Subarrays](https://leetcode.com/problems/maximum-sum-of-3-non-overlapping-subarrays/) |   [Python](./Python) | _O(n)_ | _O(n)_ | Hard ||
691 | [Stickers to Spell Word](https://leetcode.com/problems/stickers-to-spell-word/) |   [Python](./Python) | _O(T * S^T)_ | _O(T * S^T)_ | Hard || Backtracking, Memoization
712 | [Minimum ASCII Delete Sum for Two Strings](https://leetcode.com/problems/minimum-ascii-delete-sum-for-two-strings/) |   [Python](./Python) | _O(m * n)_ | _O(n)_ | Medium ||
714 | [Best Time to Buy and Sell Stock with Transaction Fee](https://leetcode.com/problems/best-time-to-buy-and-sell-stock-with-transaction-fee/) |   [Python](./Python) | _O(n)_ | _O(1)_ | Medium ||
727 | [Minimum Window Subsequence](https://leetcode.com/problems/minimum-window-subsequence/) |   [Python](./Python) | _O(s * t)_ | _O(s)_ | Hard |🔒|
730 | [Count Different Palindromic Subsequences](https://leetcode.com/problems/count-different-palindromic-subsequences/) |   [Python](./Python) | _O(n^2)_ | _O(n)_ | Hard ||
740 | [Delete and Earn](https://leetcode.com/problems/delete-and-earn/) |   [Python](./Python) | _O(n)_ | _O(1)_ | Medium ||
741 | [Cherry Pickup](https://leetcode.com/problems/cherry-pickup/) |   [Python](./Python) | _O(n^3)_ | _O(n^2)_ | Hard ||
746 | [Min Cost Climbing Stairs](https://leetcode.com/problems/min-cost-climbing-stairs/) |   [Python](./Python) | _O(n)_ | _O(1)_ | Easy ||
750 | [Number Of Corner Rectangles](https://leetcode.com/problems/number-of-corner-rectangles/) |   [Python](./Python) | _O(n * m^2)_ | _O(n * m)_ | Medium ||
764 | [Largest Plus Sign](https://leetcode.com/problems/largest-plus-sign/) |   [Python](./Python) | _O(n^2)_ | _O(n^2)_ | Medium ||
788 | [Rotated Digits](https://leetcode.com/problems/rotated-digits/) |   [Python](./Python) | _O(logn)_ | _O(logn)_ | Easy || Memoization |
790 | [Domino and Tromino Tiling](https://leetcode.com/problems/domino-and-tromino-tiling/) |   [Python](./Python) | _O(logn)_ | _O(logn)_ | Medium || Matrix Exponentiation |
799 | [Champagne Tower](https://leetcode.com/problems/champagne-tower/) |   [Python](./Python) | _O(n^2)_ | _O(n)_ | Medium |||
801 | [Minimum Swaps To Make Sequences Increasing](https://leetcode.com/problems/minimum-swaps-to-make-sequences-increasing/) |   [Python](./Python) | _O(n)_ | _O(1)_ | Medium |||
805 | [Split Array With Same Average](https://leetcode.com/problems/split-array-with-same-average/) |   [Python](./Python) | _O(n^4)_ | _O(n^3)_ | Hard |||
808 | [Soup Servings](https://leetcode.com/problems/soup-servings/) |   [Python](./Python) | _O(1)_ | _O(1)_ | Medium || Memoization |
813 | [Largest Sum of Averages](https://leetcode.com/problems/largest-sum-of-averages/) |   [Python](./Python) | _O(k * n^2)_ | _O(n)_ | Medium || |
818 | [Race Car](https://leetcode.com/problems/race-car/) |   [Python](./Python) | _O(nlogn)_ | _O(n)_ | Hard || |
823 | [Binary Trees With Factors](https://leetcode.com/problems/binary-trees-with-factors/) |   [Python](./Python) | _O(n^2)_ | _O(n)_ | Medium || |
837 | [New 21 Game](https://leetcode.com/problems/new-21-game/) |   [Python](./Python) | _O(n)_ | _O(n)_ | Medium || |
838 | [Push Dominoes](https://leetcode.com/problems/push-dominoes/) |   [Python](./Python) | _O(n)_ | _O(n)_ | Medium || |
847 | [Shortest Path Visiting All Nodes](https://leetcode.com/problems/shortest-path-visiting-all-nodes/) |   [Python](./Python) | _O(n *2^n)_ | _O(n * 2^n)_ | Hard || BFS |
877 | [Stone Game](https://leetcode.com/problems/stone-game/) |   [Python](./Python) | _O(n^2)_ | _O(n)_ | Medium | variant of [Predict the Winner](https://leetcode.com/problems/predict-the-winner/) | |
879 | [Profitable Schemes](https://leetcode.com/problems/profitable-schemes/) |   [Python](./Python) | _O(n * p * g)_ | _O(p * g)_ | Hard || |
903 | [Valid Permutations for DI Sequence](https://leetcode.com/problems/valid-permutations-for-di-sequence/) |   [Python](./Python) | _O(n^2)_ | _O(n)_ | Hard || |
920 | [Number of Music Playlists](https://leetcode.com/problems/number-of-music-playlists/) |   [Python](./Python) | _O(n * l)_ | _O(l)_ | Hard || |

## Greedy
|  #  | Title           |  Solution       |  Time           | Space           | Difficulty    | Tag          | Note|
|-----|---------------- | --------------- | --------------- | --------------- | ------------- |--------------|-----|
011| [Container With Most Water](https://leetcode.com/problems/container-with-most-water/)|   [Python](./Python) | _O(n)_ | _O(1)_ | Medium ||
042| [Trapping Rain Water](https://leetcode.com/problems/trapping-rain-water/) |   [Python](./Python) | _O(n)_ | _O(1)_ | Hard || Tricky
044| [Wildcard Matching](https://leetcode.com/problems/wildcard-matching/) | [Python](./Python) | _O(m + n)_ | _O(1)_    | Hard           || Tricky
045| [Jump Game II](https://leetcode.com/problems/jump-game-ii/)  | [Python](./Python) | _O(n)_        | _O(1)_          | Hard           ||
055| [Jump Game](https://leetcode.com/problems/jump-game/)     | [Python](./Python)  | _O(n)_          | _O(1)_          | Medium         ||
122| [Best Time to Buy and Sell Stock II](https://leetcode.com/problems/best-time-to-buy-and-sell-stock-ii/)| [Python](./Python) | _O(n)_ | _O(1)_ | Easy ||
134| [Gas Station](https://leetcode.com/problems/gas-station/)| [Python](./Python)   | _O(n)_          | _O(1)_          | Medium         ||
135| [Python](./Python) | _O(n)_ | _O(n)_ | Hard ||
316| [Remove Duplicate Letters](https://leetcode.com/problems/remove-duplicate-letters/) |   [Python](./Python) | _O(n)_| _O(k)_| Hard || Ascending Stack |
321| [Create Maximum Number](https://leetcode.com/problems/create-maximum-number/)|   [Python](./Python) | _O(k * (m + n + k))_ ~ _O(k * (m + n + k^2))_| _O(m + n + k^2)_ | Hard | variant of [Delete Digits](http://www.lintcode.com/en/problem/delete-digits/) | Greedy, DP
330| [Patching Array](https://leetcode.com/problems/patching-array/) |   [Python](./Python) | _O(s + logn)_ | _O(1)_       | Hard           ||
376| [Wiggle Subsequence](https://leetcode.com/problems/wiggle-subsequence/)|   [Python](./Python)   | _O(n)_          | _O(1)_          | Medium         ||
392| [Is Subsequence](https://leetcode.com/problems/is-subsequence/)|   [Python](./Python)   | _O(n)_          | _O(1)_          | Medium         ||
397| [Integer Replacement](https://leetcode.com/problems/integer-replacement/)|   [Python](./Python)   | _O(n)_          | _O(1)_          | Medium         || Math
402 | [Remove K Digits](https://leetcode.com/problems/remove-k-digits/) |   [Python](./Python) | _O(n)_ | _O(n)_ | Medium | LintCode |
435 | [Non-overlapping Intervals](https://leetcode.com/problems/non-overlapping-intervals/) |   [Python](./Python) | _O(nlogn)_ | _O(1)_ | Medium | | Line Sweep
452 | [Minimum Number of Arrows to Burst Balloons](https://leetcode.com/problems/minimum-number-of-arrows-to-burst-balloons/) |   [Python](./Python) | _O(nlogn)_ | _O(1)_ | Medium | |
455 | [Assign Cookies](https://leetcode.com/problems/assign-cookies/) |   [Python](./Python) | _O(nlogn)_ | _O(1)_ | Easy | |
621 | [Task Scheduler](https://leetcode.com/problems/task-scheduler/) |   [Python](./Python) | _O(n)_ | _O(1)_ | Medium | |
630 | [Course Schedule III](https://leetcode.com/problems/course-schedule-iii/) |   [Python](./Python) | _O(nlogn)_ | _O(k)_ | Hard ||
646 | [Maximum Length of Pair Chain](https://leetcode.com/problems/maximum-length-of-pair-chain/) |   [Python](./Python) | _O(nlogn)_ | _O(1)_ | Medium | similar to [Non-overlapping Intervals](https://leetcode.com/problems/non-overlapping-intervals/) | Line Sweep
649 | [Dota2 Senate](https://leetcode.com/problems/dota2-senate/) |   [Python](./Python) | _O(n)_ | _O(n)_ | Medium |||
659 | [Split Array into Consecutive Subsequences](https://leetcode.com/problems/split-array-into-consecutive-subsequences/) |   [Python](./Python) | _O(n)_ | _O(1)_ | Medium | |
738 | [Monotone Increasing Digits](https://leetcode.com/problems/monotone-increasing-digits/) |   [Python](./Python) | _O(1)_ | _O(1)_ | Medium | |
757 | [Set Intersection Size At Least Two](https://leetcode.com/problems/set-intersection-size-at-least-two/) |   [Python](./Python) | _O(nlogn)_ | _O(n)_ | Hard | |
759 | [Employee Free Time](https://leetcode.com/problems/employee-free-time/) |   [Python](./Python) | _O(m * logn)_ | _O(n)_ | Hard | |
763 | [Partition Labels](https://leetcode.com/problems/partition-labels/) |   [Python](./Python) | _O(n)_ | _O(n)_ | Medium | |
767 | [Reorganize String](https://leetcode.com/problems/reorganize-string/) |   [Python](./Python) | _O(n)_ | _O(1)_ | Medium | |
798 | [Smallest Rotation with Highest Score](https://leetcode.com/problems/smallest-rotation-with-highest-score/) |   [Python](./Python) | _O(n)_ | _O(1)_ | Hard | |
843 | [Guess the Word](https://leetcode.com/problems/guess-the-word/) |   [Python](./Python) | _O(n^2)_ | _O(n)_ | Hard || MinMax |
861 | [Score After Flipping Matrix](https://leetcode.com/problems/score-after-flipping-matrix/) |   [Python](./Python) | _O(r * c)_ | _O(1)_ | Medium ||
870 | [Advantage Shuffle](https://leetcode.com/problems/advantage-shuffle/) |   [Python](./Python) | _O(nlogn)_ | _O(n)_ | Medium ||
881 | [Boats to Save People](https://leetcode.com/problems/boats-to-save-people/) |   [Python](./Python) | _O(nlogn)_ | _O(n)_ | Medium ||

## Graph
|  #  | Title           |  Solution       |  Time           | Space           | Difficulty    | Tag          | Note|
|-----|---------------- | --------------- | --------------- | --------------- | ------------- |--------------|-----|
765 | [Couples Holding Hands](https://leetcode.com/problems/couples-holding-hands/)  |   [Python](./Python) | _O(n)_| _O(n)_| Hard           |||
924 | [Minimize Malware Spread](https://leetcode.com/problems/minimize-malware-spread/)  |   [Python](./Python) | _O(n)_| _O(n)_| Hard           || Union Find |

## Geometry
|  #  | Title           |  Solution       |  Time           | Space           | Difficulty    | Tag          | Note|
|-----|---------------- | --------------- | --------------- | --------------- | ------------- |--------------|-----|
587 | [Erect the Fence](https://leetcode.com/problems/erect-the-fence/)  |   [Python](./Python) | _O(nlogn)_| _O(n)_| Hard           || `Monotone Chain` |
892 | [Surface Area of 3D Shapes](https://leetcode.com/problems/surface-area-of-3d-shapes/)  |   [Python](./Python) | _O(n^2)_| _O(1)_| Easy           |||

## Simulation
|  #  | Title           |  Solution       |  Time           | Space           | Difficulty    | Tag          | Note|
|-----|---------------- | --------------- | --------------- | --------------- | ------------- |--------------|-----|
874 | [Walking Robot Simulation](https://leetcode.com/problems/walking-robot-simulation/)  |   [Python](./Python) | _O(n + k)_| _O(k)_| Easy           |||

## Design
|  #  | Title           |  Solution       |  Time           | Space           | Difficulty    | Tag          | Note|
|-----|---------------- | --------------- | --------------- | --------------- | ------------- |--------------|-----|
146| [LRU Cache](https://leetcode.com/problems/lru-cache/)     |   [Python](./Python)  | _O(1)_ | _O(k)_ | Hard ||
225| [Implement Stack using Queues](https://leetcode.com/problems/implement-stack-using-queues/)     |   [Python](./Python)  | push: _O(n)_, pop: _O(1)_, top: _O(1)_ | _O(n)_ | Easy ||
284| [Peeking Iterator](https://leetcode.com/problems/peeking-iterator/)|   [Python](./Python) | _O(1)_ | _O(1)_ | Medium ||
348| [Design Tic-Tac-Toe](https://leetcode.com/problems/design-tic-tac-toe/) |   [Python](./Python) | _O(1)_ | _O(n^2)_ | Medium |🔒||
353| [Design Snake Game](https://leetcode.com/problems/design-snake-game/) |   [Python](./Python) | _O(1)_ | _O(s)_ | Medium |🔒| Deque |
355| [Design Twitter](https://leetcode.com/problems/design-twitter/) |   [Python](./Python) | _O(klogu)_ | _O(t + f)_ | Medium | LintCode | Heap |
359| [Logger Rate Limiter](https://leetcode.com/problems/logger-rate-limiter/) |   [Python](./Python) | _O(1), amortized_ | _O(k)_ | Easy |🔒| Deque |
362| [Design Hit Counter](https://leetcode.com/problems/design-hit-counter/) |   [Python](./Python) | _O(1), amortized_ | _O(k)_ | Medium |🔒| Deque |
379| [Design Phone Directory](https://leetcode.com/problems/design-phone-directory/) |   [Python](./Python) | _O(1)_ | _O(n)_ | Medium |🔒| |
380| [Insert Delete GetRandom O(1)](https://leetcode.com/problems/insert-delete-getrandom-o1/) |   [Python](./Python) | _O(1)_ | _O(n)_| Hard || |
381| [Insert Delete GetRandom O(1) - Duplicates allowed](https://leetcode.com/problems/insert-delete-getrandom-o1-duplicates-allowed/) |   [Python](./Python) | _O(1)_ | _O(n)_ | Hard || |
432| [All O\`one Data Structure](https://leetcode.com/problems/all-oone-data-structure/) |   [Python](./Python) | _O(1)_ | _O(n)_| Hard || |
460| [LFU Cache](https://leetcode.com/problems/lfu-cache/) |   [Python](./Python) | _O(1)_ | _O(k)_ | Hard || |
535| [Encode and Decode TinyURL](https://leetcode.com/problems/encode-and-decode-tinyurl/) |   [Python](./Python) | _O(1)_ | _O(n)_ | Medium || |
588| [Design In-Memory File System](https://leetcode.com/problems/design-in-memory-file-system/) |   [Python](./Python) | ls: _O(l + klogk)_<br> mkdir: _O(l)_<br> addContentToFile: _O(l + c)_<br> readContentFromFile: _O(l + c)_ | _O(n + s)_ | Hard |🔒| |
604| [Design Compressed String Iterator](https://leetcode.com/problems/design-compressed-string-iterator/) |   [Python](./Python) | _O(1)_ | _O(1)_ | Easy |🔒| |
631| [Design Excel Sum Formula](https://leetcode.com/problems/design-excel-sum-formula/) |   [Python](./Python) | set: _O((r * c)^2)_<br>get: _O(1)_<br>sum: _O((r * c)^2)_ | _O(r * c)_ | Hard |🔒| |
635| [Design Log Storage System](https://leetcode.com/problems/design-log-storage-system/) |   [Python](./Python) | put: _O(1)_<br> retrieve: _O(n + dlogd)_ | _O(n)_ | Medium |🔒| |
642| [Design Search Autocomplete System](https://leetcode.com/problems/design-search-autocomplete-system/) |   [Python](./Python) | _O(p^2)_ | _O(p * t + s)_ | Hard |🔒| |
715| [Range Module](https://leetcode.com/problems/range-module/) |   [Python](./Python) | add: _O(n)_<br> remove: _O(n)_<br> query: _O(logn)_ | _O(n)_ | Hard || |
716| [Max Stack](https://leetcode.com/problems/max-stack/) |   [Python](./Python) | push: _O(logn)_<br> pop: _O(logn)_<br> popMax: _O(logn)_<br> top: _O(1)_<br> peekMax: _O(1)_ | _O(n)_ | Easy || |
745| [Prefix and Suffix Search](https://leetcode.com/problems/prefix-and-suffix-search/) |   [Python](./Python) | ctor: _O(w * l^2)_<br> search : _O(p + s)_ | _O(t)_ | Hard || Trie |
900| [RLE Iterator](https://leetcode.com/problems/rle-iterator/) |   [Python](./Python) | _O(n)_ | _O(1)_ | Medium |||
